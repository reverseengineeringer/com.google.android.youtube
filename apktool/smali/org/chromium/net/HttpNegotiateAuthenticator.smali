...
.method getNextAuthToken(JLjava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-object v2, v1, Lugm;->b:Landroid/accounts/AccountManager;

    .line 224
    iput-wide p1, v1, Lugm;->a:J
    ...
    iput-object v3, v1, Lugm;->c:Landroid/os/Bundle;

    .line 228
    if-eqz p4, :cond_0

    .line 229
    iget-object v3, v1, Lugm;->c:Landroid/os/Bundle;
    ...
    .line 1316
    :cond_2
    iget-object v0, v1, Lugm;->b:Landroid/accounts/AccountManager;

    iget-object v3, p0, Lorg/chromium/net/HttpNegotiateAuthenticator;->b:Ljava/lang/String;

    new-instance v4, Lugj;

    invoke-direct {v4, p0, v1}, Lugj;-><init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lugm;)V
