...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhfz;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lhfz;-><init>(Landroid/content/Context;Lfuj;Ljava/lang/String;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lfuj;Ljava/lang/String;Ljava/util/concurrent/Executor;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lhfz;->c:Landroid/content/Context;

    iput-object p2, p0, Lhfz;->e:Lfuj;

    const/16 v0, 0x7d0

    iput v0, p0, Lhfz;->f:I

    iput-object p4, p0, Lhfz;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Lhgd;

    iget-object v1, p0, Lhfz;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Lhgd;-><init>(Lhfz;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lhfz;->d:Lhgd;
...
.method private final a()Ljava/util/List;
    ...
    .line 0
    :try_start_0
    iget-object v0, p0, Lhfz;->e:Lfuj;

    invoke-interface {v0}, Lfuj;->a()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lhfz;->a(J)V

    invoke-direct {p0}, Lhfz;->b()Ljava/util/List;
    ...
    iget-object v0, v0, Lhge;->b:[B

    invoke-static {v0}, Lhfz;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lhak;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lhfz;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lhfz;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lhfz;->a()Ljava/util/List;
...
.method static synthetic a(Lhfz;Ljava/lang/String;)V
    .locals 7
...
.method static synthetic a(Lhfz;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lhfz;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lhfz;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lhfz;->c:Landroid/content/Context;
...
.method private final b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lhfz;->d:Lhgd;

    invoke-virtual {v0}, Lhgd;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final b()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lhge;-><init>(Ljava/lang/String;[B)V
...
.method private final declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2, v3}, Lhfz;->a(J)V
    ...
    invoke-direct {p0, v0}, Lhfz;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0, v1}, Lhfz;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, v1}, Lhfz;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Lhfz;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Lhge;->a:Ljava/lang/String;
...
.method private final d()V
    ...
    invoke-virtual {v0}, Lhgd;->close()V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
# virtual methods
.method public final a(Lhan;)V
    .locals 2

    iget-object v0, p0, Lhfz;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lhgb;

    invoke-direct {v1, p0, p1}, Lhgb;-><init>(Lhfz;Lhan;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p1}, Lhgc;-><init>(Lhfz;Ljava/lang/String;)V
...
.method public final a(Ljava/util/List;J)V
    ...
    iget-object v4, v0, Lhak;->a:Ljava/lang/String;

    iget-object v0, v0, Lhak;->b:Ljava/lang/Object;

    invoke-static {v0}, Lhfz;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lhge;-><init>(Ljava/lang/String;[B)V
    ...
    invoke-direct {v2, p0, v1, p2, p3}, Lhga;-><init>(Lhfz;Ljava/util/List;J)V
