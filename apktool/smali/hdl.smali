...
# instance fields
.field private final b:Lhdn;

.field private volatile c:Lhgi;

.field private final d:Lhcj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhdl;->a:Ljava/lang/String;

    return-void
.end method

.method constructor <init>(Lhcj;Landroid/content/Context;)V
    .locals 1

    const-string v0, "gtm_urls.db"

    invoke-direct {p0, p1, p2, v0}, Lhdl;-><init>(Lhcj;Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method private constructor <init>(Lhcj;Landroid/content/Context;Ljava/lang/String;)V
    .locals 4
    ...
    iput-object v0, p0, Lhdl;->e:Landroid/content/Context;

    iput-object p3, p0, Lhdl;->f:Ljava/lang/String;

    iput-object p1, p0, Lhdl;->d:Lhcj;

    invoke-static {}, Lfun;->c()Lfuj;

    move-result-object v0

    iput-object v0, p0, Lhdl;->h:Lfuj;

    new-instance v0, Lhdn;

    iget-object v1, p0, Lhdl;->e:Landroid/content/Context;

    iget-object v2, p0, Lhdl;->f:Ljava/lang/String;

    invoke-direct {v0, p0, v1, v2}, Lhdn;-><init>(Lhdl;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lhdl;->b:Lhdn;
    ...
    iget-object v2, p0, Lhdl;->e:Landroid/content/Context;

    new-instance v3, Lhdm;

    invoke-direct {v3, p0}, Lhdm;-><init>(Lhdl;)V

    invoke-direct {v0, v1, v2, v3}, Lheu;-><init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lhev;)V

    iput-object v0, p0, Lhdl;->c:Lhgi;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lhdl;->g:J
...
.method private final a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lhdl;->b:Lhdn;

    invoke-virtual {v0}, Lhdn;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
...
.method static synthetic a(Lhdl;)Lfuj;
    .locals 1

    iget-object v0, p0, Lhdl;->h:Lfuj;
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lhdl;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final a(J)V
    ...
    invoke-direct {p0, v0}, Lhdl;->a([Ljava/lang/String;)V

    return-void
.end method

.method static synthetic a(Lhdl;J)V
    .locals 1

    invoke-direct {p0, p1, p2}, Lhdl;->a(J)V

    return-void
.end method

.method static synthetic a(Lhdl;JJ)V
    .locals 7
...
.method private final a([Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lhdl;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v2, p0, Lhdl;->d:Lhcj;

    invoke-direct {p0}, Lhdl;->c()I
    ...
    :goto_1
    invoke-interface {v2, v0}, Lhcj;->a(Z)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method static synthetic b(Lhdl;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lhdl;->f:Ljava/lang/String;
...
.method private final b()Ljava/util/List;
    ...
    invoke-direct {v0, v2}, Lhdl;->a(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Lhce;-><init>(JJ)V
    ...
    invoke-static {v3}, Lhav;->b(Ljava/lang/String;)V
    :try_end_5
    ...
    :cond_9
    :try_start_6
    iput-object v5, v2, Lhce;->c:Ljava/lang/String;
    :try_end_6
    ...
    .line 6000
    iget-object v6, v2, Lhce;->c:Ljava/lang/String;
...
.method static synthetic c(Lhdl;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lhdl;->e:Landroid/content/Context;
...
.method public final a()V
    ...
    iget-object v0, p0, Lhdl;->c:Lhgi;

    invoke-interface {v0}, Lhgi;->a()Z
    ...
    :cond_1
    invoke-direct {p0}, Lhdl;->b()Ljava/util/List;
    ...
    iget-object v0, p0, Lhdl;->d:Lhcj;

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Lhcj;->a(Z)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Lhdl;->c:Lhgi;

    invoke-interface {v1, v0}, Lhgi;->a(Ljava/util/List;)V

    invoke-direct {p0}, Lhdl;->d()I
...
.method public final a(JLjava/lang/String;)V
    ...
    .line 1000
    iget-object v2, p0, Lhdl;->h:Lfuj;

    invoke-interface {v2}, Lfuj;->a()J

    move-result-wide v2

    iget-wide v4, p0, Lhdl;->g:J
    ...
    invoke-direct {p0, v0}, Lhdl;->a(I)Ljava/util/List;
