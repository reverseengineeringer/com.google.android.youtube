...
.method public constructor <init>(Ljava/io/InputStream;Lawj;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lawj;

    .line 100
    new-instance v0, Lbcg;

    invoke-direct {v0, p1}, Lbcg;-><init>(Ljava/io/InputStream;)V

    iput-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbcf;

    .line 101
    return-void
.end method

.method public constructor <init>(Ljava/nio/ByteBuffer;Lawj;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lbcd;-><init>(Ljava/nio/ByteBuffer;)V
...
.method private static a(Lbce;)I
    .locals 10
    ...
    invoke-virtual {p0, v0}, Lbce;->b(I)S
    ...
    .line 5392
    :goto_0
    iget-object v1, p0, Lbce;->a:Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v0}, Lbce;->a(I)I
    ...
    .line 304
    invoke-virtual {p0, v1}, Lbce;->b(I)S
    ...
    .line 309
    invoke-virtual {p0, v3}, Lbce;->b(I)S
    ...
    invoke-virtual {p0, v5}, Lbce;->b(I)S
    ...
    invoke-virtual {p0, v6}, Lbce;->a(I)I
    ...
    .line 6396
    iget-object v5, p0, Lbce;->a:Ljava/nio/ByteBuffer;
    ...
    .line 7396
    iget-object v6, p0, Lbce;->a:Ljava/nio/ByteBuffer;
...
.method private final c()I
    ...
    .line 246
    :cond_0
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbcf;

    invoke-interface {v1}, Lbcf;->b()S
    ...
    .line 269
    iget-object v3, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbcf;

    int-to-long v4, v1

    invoke-interface {v3, v4, v5}, Lbcf;->a(J)J
...
.method public final a()Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType;
    ...
    .line 116
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbcf;

    invoke-interface {v0}, Lbcf;->a()I
    ...
    invoke-interface {v0, v2, v3}, Lbcf;->a(J)J

    .line 129
    iget-object v0, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->d:Lbcf;

    invoke-interface {v0}, Lbcf;->c()I
    ...
    invoke-interface {v0, v6, v7}, Lbcf;->a(J)J
...
.method public final b()I
    ...
    .line 193
    iget-object v2, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lawj;

    invoke-interface {v2, v1}, Lawj;->a(I)[B
    ...
    invoke-interface {v3, v2, v1}, Lbcf;->a([BI)I
    ...
    :cond_4
    :goto_2
    iget-object v1, p0, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->c:Lawj;

    invoke-interface {v1, v2}, Lawj;->a([B)V
    ...
    invoke-direct {v0, v2, v1}, Lbce;-><init>([BI)V

    invoke-static {v0}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;->a(Lbce;)I
    :try_end_1
