...
# direct methods
.method constructor <init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lhev;)V
    .locals 9
    ...
    iput-object v1, p0, Lheu;->c:Landroid/content/Context;
    ...
    .line 0
    iput-object v0, p0, Lheu;->a:Ljava/lang/String;

    iput-object p1, p0, Lheu;->b:Lorg/apache/http/client/HttpClient;

    iput-object p3, p0, Lheu;->d:Lhev;
...
.method private static a(Lhce;)Ljava/net/URL;
    .locals 2
...
.method private final a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    iget-object v2, p0, Lheu;->a:Ljava/lang/String;
...
.method public final a(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lheu;->a(Lhce;)Ljava/net/URL;
    ...
    iget-object v2, p0, Lheu;->d:Lhev;

    invoke-interface {v2, v0}, Lhev;->b(Lhce;)V
    ...
    :cond_0
    invoke-direct {p0, v2}, Lheu;->a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-static {v6}, Lheu;->a(Lorg/apache/http/HttpEntityEnclosingRequest;)V

    if-eqz v1, :cond_2

    :try_start_0
    iget-object v2, p0, Lheu;->c:Landroid/content/Context;

    invoke-static {v2}, Lhcw;->a(Landroid/content/Context;)V

    move v1, v3

    :cond_2
    iget-object v2, p0, Lheu;->b:Lorg/apache/http/client/HttpClient;
    ...
    invoke-interface {v2, v0}, Lhev;->c(Lhce;)V
    ...
    invoke-interface {v2, v0}, Lhev;->a(Lhce;)V
    :try_end_0
    ...
    invoke-static {v6}, Lhav;->b(Ljava/lang/String;)V
...
.method public final a()Z
    ...
    iget-object v0, p0, Lheu;->c:Landroid/content/Context;
