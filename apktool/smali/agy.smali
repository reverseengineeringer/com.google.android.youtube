...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 52
    iput-object p1, p0, Lagy;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lgt;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 81
    invoke-direct {p0, v0, p2}, Lagy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Lgt;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Lagy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 104
    iget-object v0, p0, Lagy;->a:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 105
    iput-object v1, p0, Lagy;->a:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 57
    iget-object v0, p0, Lagy;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lagy;->b:[I
    ...
    .line 60
    invoke-virtual {v4, v3}, Laco;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 62
    iget-object v5, p0, Lagy;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v9}, Lagy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 65
    :cond_2
    invoke-virtual {v4, v9}, Laco;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 67
    iget-object v1, p0, Lagy;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v0, v3}, Lagy;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
