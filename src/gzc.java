  ...
  implements gza
{
  ...
  public final void a(int paramInt, Account paramAccount, gyx paramgyx)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAccount != null)
        {
          ...
          if (paramgyx != null)
          {
            paramAccount = paramgyx.asBinder();
  ...
  public final void a(AuthAccountRequest paramAuthAccountRequest, gyx paramgyx)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAuthAccountRequest != null)
        {
          ...
          if (paramgyx != null)
          {
            paramAuthAccountRequest = paramgyx.asBinder();
  ...
  public final void a(ResolveAccountRequest paramResolveAccountRequest, ftt paramftt)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramResolveAccountRequest != null)
        {
          ...
          if (paramftt != null)
          {
            paramResolveAccountRequest = paramftt.asBinder();
  ...
  public final void a(com.google.android.gms.signin.internal.CheckServerAuthResult paramCheckServerAuthResult)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	gzc:a	Landroid/os/IBinder;
    //   33: iconst_3
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
  ...
  public final void a(RecordConsentRequest paramRecordConsentRequest, gyx paramgyx)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramRecordConsentRequest != null)
        {
          ...
          if (paramgyx != null)
          {
            paramRecordConsentRequest = paramgyx.asBinder();
  ...
  /* Error */
  public final void a(frw paramfrw, int paramInt, boolean paramBoolean)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   58: aload_0
    //   59: getfield 15	gzc:a	Landroid/os/IBinder;
    //   62: bipush 9
    //   64: aload 5
    //   66: aload 6
    //   68: iconst_0
  ...
  /* Error */
  public final void a(gyx paramgyx)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
    ...
    //   30: aload_0
    //   31: getfield 15	gzc:a	Landroid/os/IBinder;
    //   34: bipush 11
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
