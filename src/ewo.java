  ...
  implements ews
{
  ...
  public ewo(fbg paramfbg, long paramLong1, long paramLong2)
  {
    b = paramfbg;
    d = paramLong1;
    c = paramLong2;
  ...
  private final int a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
  ...
  private final int d(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    if (g == 0) {
      return 0;
    }
