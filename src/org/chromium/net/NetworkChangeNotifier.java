...
public class NetworkChangeNotifier
{
  ...
  private final void b(double paramDouble)
  {
  ...
  final void a(boolean paramBoolean, NetworkChangeNotifierAutoDetect.RegistrationPolicy paramRegistrationPolicy)
  {
    if (paramBoolean) {
      if (e == null)
      {
        e = new NetworkChangeNotifierAutoDetect(new uhy(this), b, paramRegistrationPolicy);
        paramRegistrationPolicy = e.e.a();
        b(NetworkChangeNotifierAutoDetect.a(paramRegistrationPolicy));
    ...
    paramRegistrationPolicy = e;
    d.b();
    paramRegistrationPolicy.a();
    e = null;
  }
  ...
  public int getCurrentDefaultNetId()
  {
    ...
    do
    {
      ...
      localObject = e;
      localNetworkInfo1 = a.getActiveNetworkInfo();
      k = i;
    ...
    for (;;)
    {
      ...
      k = i;
      if (((uhz)localObject).b(localNetwork))
      {
  ...
  public int[] getCurrentNetworksAndTypes()
  {
    ...
    Network[] arrayOfNetwork = e.a.getAllNetworks();
    int[] arrayOfInt = new int[arrayOfNetwork.length << 1];
    int m = arrayOfNetwork.length;
    int i = 0;
    int k;
    for (int j = 0; i < m; j = k)
    {
      ...
      {
        int n = j + 1;
        arrayOfInt[j] = Integer.parseInt(localNetwork.toString());
        k = n + 1;
        arrayOfInt[n] = NetworkChangeNotifierAutoDetect.a(e.a(localNetwork));
      }
      i += 1;
    }
