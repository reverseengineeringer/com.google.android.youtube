...
public class CronetLibraryLoader
{
  ...
  public static void a(Context paramContext, CronetEngine.Builder paramBuilder)
  {
    synchronized (a)
    {
      ...
      if (!"49.0.2623.34".equals(nativeGetCronetVersion())) {
        throw new RuntimeException(String.format("Expected Cronet version number %s, actual version number %s.", new Object[] { "49.0.2623.34", nativeGetCronetVersion() }));
      }
    }
    ContextUtils.a(paramContext.getApplicationContext());
    paramContext = new ufu(paramContext);
