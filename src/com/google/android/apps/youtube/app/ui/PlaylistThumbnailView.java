  ...
  extends ViewGroup
{
  ...
  private final void a(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    f = localResources.getFraction(tcf.a, 1, 1);
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, tco.k, paramInt1, paramInt2);
    j = paramAttributeSet.getBoolean(tco.q, false);
    b.setTextSize(0, paramAttributeSet.getDimension(tco.n, localResources.getDimension(tcd.M)));
    b.setTextColor(paramAttributeSet.getColor(tco.m, localResources.getColor(17170443)));
    paramInt1 = paramAttributeSet.getResourceId(tco.l, 0);
    if (paramInt1 != 0) {
      k = fv.a(paramContext, paramInt1);
    }
    g = localResources.getColor(paramAttributeSet.getResourceId(tco.o, tcc.T));
    h = localResources.getColor(paramAttributeSet.getResourceId(tco.p, tcc.U));
...
/* Location:
 * Qualified Name:     com.google.android.apps.youtube.app.ui.PlaylistThumbnailView
