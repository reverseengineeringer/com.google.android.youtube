...
{
  public static final Parcelable.Creator CREATOR = new gip();
  public Messenger a;
  public git b;
  ...
  public MessengerCompat(IBinder paramIBinder)
  {
    ...
    for (;;)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof git))) {
        paramIBinder = (git)localIInterface;
      } else {
        paramIBinder = new giv(paramIBinder);
      }
    }
  }
