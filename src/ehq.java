  ...
  implements mbr
{
  ...
  public ehq(Context paramContext, mji parammji, qrk paramqrk, mgy parammgy, mha parammha, irf paramirf)
  {
    jju.a(paramContext);
    ...
    b = View.inflate(paramContext, tci.bU, null);
    ...
    jrg.a(b, l);
    b.setOnClickListener(new ehr(this, paramqrk));
    b.setOnTouchListener(new ehs(paramirf));
  }
