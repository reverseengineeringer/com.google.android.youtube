  ...
  extends FilterInputStream
{
  ...
  public bci(InputStream paramInputStream, awj paramawj)
  {
    this(paramInputStream, paramawj, (byte)0);
  }
  
  private bci(InputStream paramInputStream, awj paramawj, byte paramByte)
  {
  ...
  private final int a(InputStream paramInputStream, byte[] paramArrayOfByte)
  {
    if ((d == -1) || (e - d >= c))
    {
  ...
  public final void reset()
  {
    ...
    if (-1 == d)
    {
      int i = e;
      int j = c;
      throw new bcj(66 + "Mark has been invalidated, pos: " + i + " markLimit: " + j);
    }
    e = d;
  }
