...
{
  public static String a(gjy paramgjy)
  {
    if (paramgjy == null) {
      return "";
    }
    ...
    try
    {
      a(null, paramgjy, new StringBuffer(), localStringBuffer);
      return localStringBuffer.toString();
    }
    catch (IllegalAccessException paramgjy)
    {
      return "Error printing proto: " + paramgjy.getMessage();
    }
    catch (InvocationTargetException paramgjy) {}
    return "Error printing proto: " + paramgjy.getMessage();
  }
