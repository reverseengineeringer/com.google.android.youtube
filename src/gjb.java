  ...
  implements giz
{
  ...
  public final void a(Bundle paramBundle)
  {
    ...
    //   25: aload_0
    //   26: getfield 15	gjb:a	Landroid/os/IBinder;
    //   29: bipush 9
    //   31: aload_2
    //   32: aconst_null
    //   33: iconst_1
  ...
  /* Error */
  public final void a(Bundle paramBundle, gjf paramgjf)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
    ...
    //   50: aload_0
    //   51: getfield 15	gjb:a	Landroid/os/IBinder;
    //   54: iconst_5
    //   55: aload 4
    //   57: aconst_null
    //   58: iconst_1
  ...
  public final void a(CreateWalletObjectsRequest paramCreateWalletObjectsRequest, Bundle paramBundle, gjf paramgjf)
  {
      ...
      try
      {
        ...
        if (paramCreateWalletObjectsRequest != null)
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (paramgjf != null) {
              paramCreateWalletObjectsRequest = paramgjf.asBinder();
            }
  ...
  public final void a(FullWalletRequest paramFullWalletRequest, Bundle paramBundle, gjf paramgjf)
  {
    Object localObject = null;
    Parcel localParcel = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramFullWalletRequest != null)
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (paramgjf != null) {
              paramFullWalletRequest = paramgjf.asBinder();
            }
  ...
  public final void a(MaskedWalletRequest paramMaskedWalletRequest, Bundle paramBundle, gjc paramgjc)
  {
    Object localObject = null;
    Parcel localParcel = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramMaskedWalletRequest != null)
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (paramgjc != null) {
              paramMaskedWalletRequest = paramgjc.asBinder();
            }
  ...
  public final void a(MaskedWalletRequest paramMaskedWalletRequest, Bundle paramBundle, gjf paramgjf)
  {
    Object localObject = null;
    Parcel localParcel = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramMaskedWalletRequest != null)
        {
          ...
          if (paramBundle != null)
          {
            ...
            paramMaskedWalletRequest = (MaskedWalletRequest)localObject;
            if (paramgjf != null) {
              paramMaskedWalletRequest = paramgjf.asBinder();
            }
            localParcel.writeStrongBinder(paramMaskedWalletRequest);
  ...
  public final void a(GetBuyFlowInitializationTokenRequest paramGetBuyFlowInitializationTokenRequest, Bundle paramBundle, gjf paramgjf)
  {
    Object localObject = null;
    Parcel localParcel = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramGetBuyFlowInitializationTokenRequest != null)
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (paramgjf != null) {
              paramGetBuyFlowInitializationTokenRequest = paramgjf.asBinder();
            }
  ...
  public final void a(GetInstrumentsRequest paramGetInstrumentsRequest, Bundle paramBundle, gjf paramgjf)
  {
    Object localObject = null;
    Parcel localParcel = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramGetInstrumentsRequest != null)
        {
          ...
          if (paramBundle != null)
          {
            ...
            if (paramgjf != null) {
              paramGetInstrumentsRequest = paramgjf.asBinder();
            }
  ...
  /* Error */
  public final void a(String paramString1, String paramString2, Bundle paramBundle, gjf paramgjf)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 5
    ...
    //   15: aload 6
    //   17: aload_1
    //   18: invokevirtual 90	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   21: aload 6
    //   23: aload_2
    //   24: invokevirtual 90	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   27: aload_3
    //   28: ifnull +59 -> 87
    //   31: aload 6
    //   33: iconst_1
    ...
    //   66: aload_0
    //   67: getfield 15	gjb:a	Landroid/os/IBinder;
    //   70: iconst_3
    //   71: aload 6
    //   73: aconst_null
    //   74: iconst_1
  ...
  /* Error */
  public final void b(Bundle paramBundle, gjf paramgjf)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_3
