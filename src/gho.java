  ...
  implements ghm
{
  ...
  public final void a(Bitmap paramBitmap, ghj paramghj)
  {
  ...
  public final void a(GoogleHelp paramGoogleHelp, Bitmap paramBitmap, ghj paramghj)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramGoogleHelp != null)
        {
          ...
          if (paramBitmap != null)
          {
            ...
            paramGoogleHelp = paramghj.asBinder();
  ...
  public final void a(GoogleHelp paramGoogleHelp, ghj paramghj)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  /* Error */
  public final void a(ghj paramghj)
  {
    // Byte code:
    ...
    //   30: aload_0
    //   31: getfield 15	gho:a	Landroid/os/IBinder;
    //   34: iconst_4
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
  ...
  /* Error */
  public final void b(ghj paramghj)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
  ...
  /* Error */
  public final void c(ghj paramghj)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore_2
