...
public final class nz
{
  ...
  public final boolean a(float paramFloat1, float paramFloat2)
  {
    if ((a) && (c != null))
    {
      ...
      View localView = b;
      return pu.a.a(localViewParent, localView, paramFloat1, paramFloat2);
    }
    return false;
  }
  ...
  public final boolean a(float paramFloat1, float paramFloat2, boolean paramBoolean)
  {
    if ((a) && (c != null))
    {
      ViewParent localViewParent = c;
      View localView = b;
      return pu.a.a(localViewParent, localView, paramFloat1, paramFloat2, paramBoolean);
    }
    return false;
  }
  ...
  public final boolean a(int paramInt)
  {
    ...
    if (a)
    {
      ...
      {
        View localView2 = b;
        if (pu.a.a(localViewParent, localView1, localView2, paramInt))
        {
          c = localViewParent;
          localView2 = b;
          pu.a.b(localViewParent, localView1, localView2, paramInt);
          return true;
        }
  ...
  public final boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ViewParent localViewParent = c;
      View localView = b;
      pu.a.a(localViewParent, localView, paramInt1, paramInt2, paramInt3, paramInt4);
      if (paramArrayOfInt != null)
      {
        b.getLocationInWindow(paramArrayOfInt);
        paramArrayOfInt[0] -= j;
  ...
  public final boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        ViewParent localViewParent = c;
        View localView = b;
        pu.a.a(localViewParent, localView, paramInt1, paramInt2, paramArrayOfInt1);
        if (paramArrayOfInt2 != null)
        {
          b.getLocationInWindow(paramArrayOfInt2);
  ...
  public final void b()
  {
    if (c != null)
    {
      ViewParent localViewParent = c;
      View localView = b;
      pu.a.a(localViewParent, localView);
      c = null;
    }
  }
}
