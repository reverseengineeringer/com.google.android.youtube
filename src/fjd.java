...
{
  fjd(fjc paramfjc, Context paramContext, String paramString)
  {
  ...
  private final boolean a(SQLiteDatabase paramSQLiteDatabase, String paramString)
  {
    ...
    //   26: aconst_null
    //   27: aconst_null
    //   28: invokevirtual 78	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   31: astore_1
    //   32: aload_1
    //   33: astore 4
    //   35: aload 4
    ...
    //   67: astore_1
    //   68: aload_0
    //   69: getfield 10	fjd:a	Lfjc;
    //   72: ldc 89
    //   74: aload_2
    //   75: aload 5
    //   77: invokevirtual 95	fjc:c	(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    //   80: aload 4
    //   82: ifnull +10 -> 92
    //   85: aload 4
  ...
  public final SQLiteDatabase getWritableDatabase()
  {
    ...
    {
      fjc.a(a).a();
      a.e("Opening the database failed, dropping the table and recreating it");
      Object localObject = fjc.b(a);
      a.d.a.getDatabasePath((String)localObject).delete();
      try
      {
  ...
  public final void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramSQLiteDatabase.execSQL(fjc.a);
