...
public class NestedScrollView
  ...
  implements ny, oa, oe
{
  private static final to w = new to();
  private static final int[] x = { 16843130 };
  private float A;
  public tp a;
  private long b;
  private final Rect c = new Rect();
  private uc d = new uc(getContext(), null);
  private tc e;
  private tc f;
  private int g;
  ...
  {
    paramParcelable = (tq)paramParcelable;
  ...
  {
    tq localtq = new tq(super.onSaveInstanceState());
    a = getScrollY();
    return localtq;
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (k)
    {
      ...
      if ((k) && (getChildCount() > 0) && (d.b(getScrollX(), getScrollY(), a()))) {
        ok.c(this);
      }
      r = -1;
      d();
