  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      localObject = new abc(this);
      setBackgroundDrawable((Drawable)localObject);
      paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, ya.a);
      b = paramContext.getDrawable(ya.b);
      c = paramContext.getDrawable(ya.d);
      j = paramContext.getDimensionPixelSize(ya.j, -1);
      if (getId() == xv.I)
      {
        e = true;
        d = paramContext.getDrawable(ya.c);
      }
