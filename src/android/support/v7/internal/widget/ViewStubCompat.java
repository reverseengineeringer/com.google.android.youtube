  ...
  extends View
{
  ...
  public ViewStubCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, ya.cx, paramInt, 0);
    c = paramContext.getResourceId(ya.cz, -1);
    b = paramContext.getResourceId(ya.cA, 0);
    setId(paramContext.getResourceId(ya.cy, -1));
