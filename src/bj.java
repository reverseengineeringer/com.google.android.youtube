...
public final class bj
{
  ...
  public static List a(Context paramContext, ApplicationInfo paramApplicationInfo, File paramFile, boolean paramBoolean)
  {
    int i = 0;
    ...
    long l2 = bl.a(paramApplicationInfo);
    long l1 = l2;
    if (l2 == -1L) {
      l1 = l2 - 1L;
    }
  ...
  private static List a(Context paramContext, File paramFile1, File paramFile2)
  {
  ...
  private static void a(File paramFile, String paramString)
  {
    ...
    paramString = paramFile.listFiles(new bk(paramString));
    if (paramString == null)
    {
    ...
    if (i < j)
    {
      ...
      Log.w("MultiDex", "Trying to delete old file " + paramFile.getPath() + " of size " + paramFile.length());
      if (paramFile.delete()) {
        break label183;
      }
    ...
    for (;;)
    {
      ...
      break;
      label183:
      Log.w("MultiDex", "Deleted old file " + paramFile.getPath());
    }
  }
